...
export default function ReviewsPage() {
    ...
    useEffect(() => {
        ...
        // TODO: Replace with Firestore listener
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        if (!user) {
            router.push(`/login?redirect=/experiencia/${id}/avaliacoes`);
            return;
        }
        setSubmitting(true);
        ...
        <main className="min-h-screen bg-white pb-24 selection:bg-crystal selection:text-ocean">
            ...
            <div className="relative h-64 sm:h-80 overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 sm:p-12 text-white">
                    <button onClick={() => router.back()} className="mb-4 text-sm opacity-70 hover:opacity-100 flex items-center gap-2">
            ...
            <div className="max-w-6xl mx-auto px-6 -mt-8 relative z-10">
                ...
                {!showForm && (
                    <button
                        onClick={() => user ? setShowForm(true) : router.push(`/login?redirect=/experiencia/${id}/avaliacoes`)}

...
export default function Home() {
  ...
  // Removed mandatory login redirect for public browsing
  ...
  // Removed blocking loading state to allow instant LCP
  ...
  return (
    <main className="min-h-screen bg-white selection:bg-crystal selection:text-ocean overflow-x-hidden">
      ...
      <section className="pt-32 pb-16 px-6 max-w-[1600px] mx-auto">
        <BentoGrid>
          ...
          <BentoCard span="medium" className="bg-crystal flex flex-col justify-between">
            {loading ? (
              // Local skeleton for loading state
              <div className="animate-pulse space-y-4 w-full">
                <div className="h-4 bg-ocean/10 rounded w-1/3"></div>
                <div className="h-8 bg-ocean/10 rounded w-3/4"></div>
                <div className="flex gap-4 mt-8">
                  <div className="w-12 h-12 bg-ocean/10 rounded-2xl"></div>
                  <div className="space-y-2 flex-1">
                    <div className="h-3 bg-ocean/10 rounded w-1/4"></div>
          ...
          {/* Secondary CTA Card */}
          <BentoCard span="small" className="!bg-ocean flex flex-col justify-between group cursor-pointer border-none" onClick={() => router.push("/viagens")}>
      ...
      <section className="px-6 py-8 sticky top-20 bg-white/80 backdrop-blur-xl z-40 border-y border-slate-100">
